        ...
        <div className="clientcard__container__form">
            <div className="clientcard__container__fields">
                <div className="clientcard__container__field">
                    <label className="clientcard__label">
                        Nafn
                    </label>
                    <input type="text" value={client.clientName} onChange={handleChange} className="clientcard__input" />
                </div>
            </div>
            ...
            <div className="clientcard__button__container">
                ...
                <div className="clientcard__button__container">
                    <button className="clientcard__button__save" disabled={!isValid()} onClick={() => save(client)}>Vista</button>
                </div>
